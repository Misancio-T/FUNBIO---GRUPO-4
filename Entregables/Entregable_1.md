...
Los accidentes automovilísticos son la principal causa de lesiones más reciente, seguidos de cerca por las caídas. Los actos de violencia (en primer lugar, las heridas de bala) y las actividades deportivas/recreativas también son causas relativamente frecuentes  [[3]](https://github.com/Misancio-T/FUNBIO---GRUPO-4/blob/main/Entregables/Entregable_1.md#8-bibliograf%C3%ADa).
...
A nivel neurológico y magnitud de lesión la tetraplejia incompleta es la categoría neurológica más frecuente. La frecuencia de la paraplejia incompleta y la completa es prácticamente la misma. Menos del 1 % de las personas tuvieron una recuperación neurológica completa para cuando recibieron el alta médica  [[3]](https://github.com/Misancio-T/FUNBIO---GRUPO-4/blob/main/Entregables/Entregable_1.md#8-bibliograf%C3%ADa).
...
También, observamos que el promedio de esperanza de vida de las personas con SCI no ha mejorado desde la década de 1980 al 2015 y sigue estando muy por debajo de la esperanza de vida de las personas sin SCI. Los índices de mortalidad son considerablemente más altos durante el primer año después de la lesión que en los años siguientes, sobre todo en el caso de las personas con un deterioro neurológico más grave [[3]](https://github.com/Misancio-T/FUNBIO---GRUPO-4/blob/main/Entregables/Entregable_1.md#8-bibliograf%C3%ADa).
...
|-----------|--------------|-------------------------|------------|---------------|
| Uso de sensores inerciales en fisioterapia: Una aproximación a procesos de evaluación del movimiento humano | Julialba Castellanos Ruíz, Lina María Montealegre Mesa, Brahian Daniel Martíne Toro, Juan José Gallo Serna , Osvaldo Almanza Fuentes | <p align="center">2020</p> | Este artículo tiene como objetivo analizar  la  información  sobre  el  uso  de  sensores  inerciales como  una  aproximación  a  los  procesos  de  evaluación  del  movimiento  corporal  humano. Esta Unidad de Medición Inercial (IMU) es compatible con aplicaciones (APP), con el objetivo de obtener datos de movimiento tridimensionales y como evaluación e intervención, o que permita cuantificar los resultados de la acción motora. | <p align="center">[Más información](https://revistas.udenar.edu.co/index.php/usalud/article/view/5284/6932)</p> |
...
| Rehabilitación y readaptación de las lesiones medulares adquiridas del adulto: tetraplejias AIS A | C. Gournay; C.Hugeron | <p align="center">2024</p> | El artículo habla sobre el impacto de la tetraplejia AIS A (estadio A de la American Spinal Injury Association Impairment Scale) en la independencia y autonomía funcional de los pacientes. | <p align="center">[Más información](https://www.sciencedirect.com/science/article/pii/S1293296523486707)</p> |
| Sensores de movimiento portátiles para la rehabilitación: de la tecnología a la práctica clínica | Gerrit Ruben Hendrik Regterschot ,Gerard M. Ribbers, Juan B. J. Bussmann | <p align="center">2020</p> | Los trastornos motores aumentan debido al envejecimiento de la población, lo que demanda mejoras en la rehabilitación médica. Los sensores portátiles de movimiento pueden optimizar este proceso al proporcionar mediciones objetivas en diversos entornos. Aunque su potencial es grande, su uso en la práctica clínica sigue siendo limitado. Este número especial incluye 17 estudios que abordan el desarrollo de algoritmos, la validación de sensores y su aplicación en la rehabilitación motora. | <p align="center">[Más información](https://www.mdpi.com/1424-8220/21/14/4744)</p> |
| Plantar pressure measurement system based on piezoelectric sensor: a review | Xiang Li, Keyi Wang, Yan Lin Wang, Kui Cheng Wang | <p align="center">2022</p> | Este artículo revisa las tecnologías de medición de la fuerza plantar usando sensores piezoeléctricos, útiles para rehabilitación, diseño de calzado, diagnóstico clínico y deportes. Analiza los principios de funcionamiento y diseños de sensores, como monolaterales y multicapa. Aunque los sensores piezoeléctricos son sensibles y fáciles de fabricar, su eficacia varía con la disposición de los sensores, lo que subraya la necesidad de más investigación para mejorar los sistemas de medición. | <p align="center">[Más información](https://ieeexplore.ieee.org/abstract/document/9677765)</p> |
